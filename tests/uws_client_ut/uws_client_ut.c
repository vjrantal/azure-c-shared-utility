...
/* Tests_SRS_UWS_CLIENT_01_005: [ If `use_ssl` is 0 then `uws_client_create` shall obtain the interface used to create a socketio instance by calling `socketio_get_interface_description`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_422: [ `uws_client_create` shall create a buffer to be used for encoding outgoing frames by calling `BUFFER_new`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_006: [ If `use_ssl` is 1 then `uws_client_create` shall obtain the interface used to create a tlsio instance by calling `platform_get_default_tlsio`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_023: [ `uws_client_destroy` shall ensure the underlying IO created in `uws_client_open` is destroyed by calling `xio_destroy`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_025: [ `uws_client_open` shall open the underlying IO by calling `xio_open` and providing the IO handle created in `uws_client_create` as argument. ]*/
...
TEST_FUNCTION(uws_client_open_with_NULL_handle_fails)
{
    ...
    // act
    result = uws_client_open(NULL, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_open_complete_callback_fails)
{
    ...
    // act
    result = uws_client_open(uws_client, NULL, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_frame_received_callback_fails)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, NULL, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_peer_closed_callback_fails)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, NULL, (void*)0x4301, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_error_callback_fails)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, NULL, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_open_complete_context_succeeds)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, NULL, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_frame_received_context_succeeds)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, NULL, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_peer_closed_context_succeeds)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, NULL, test_on_ws_error, (void*)0x4244);
...
TEST_FUNCTION(uws_client_open_with_NULL_on_ws_error_context_succeeds)
{
    ...
    // act
    result = uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, NULL);
...
TEST_FUNCTION(uws_client_open_while_closing_fails)
{
    ...
    uws_client = uws_client_create("test_host", 444, "/aaa", true, protocols, sizeof(protocols) / sizeof(protocols[0]));
    (void)uws_client_open(uws_client, test_on_ws_open_complete, (void*)0x4242, test_on_ws_frame_received, (void*)0x4243, test_on_ws_peer_closed, (void*)0x4301, test_on_ws_error, (void*)0x4244);
    (void)uws_client_close(uws_client, test_on_ws_close_complete, NULL);
    umock_c_reset_all_calls();
...
/* Tests_SRS_UWS_CLIENT_01_031: [ `uws_client_close` shall close the connection by calling `xio_close` while passing as argument the IO handle created in `uws_client_create`. ]*/
...
TEST_FUNCTION(uws_client_close_closes_the_underlying_IO)
{
    ...
    // act
    result = uws_client_close(uws_client, test_on_ws_close_complete, (void*)0x4242);
...
TEST_FUNCTION(uws_client_close_with_NULL_handle_fails)
{
    ...
    // act
    result = uws_client_close(NULL, test_on_ws_close_complete, (void*)0x4242);
...
TEST_FUNCTION(uws_client_close_with_NULL_close_complete_callback_is_allowed)
{
    ...
    // act
    result = uws_client_close(uws_client, NULL, (void*)0x4242);
...
TEST_FUNCTION(uws_client_close_with_NULL_close_context_succeeds)
{
    ...
    // act
    result = uws_client_close(uws_client, test_on_ws_close_complete, NULL);
...
TEST_FUNCTION(uws_client_close_while_WAITING_for_close_frame_fails)
{
    ...
    g_on_io_open_complete(g_on_io_open_complete_context, IO_OPEN_OK);
    g_on_bytes_received(g_on_bytes_received_context, (const unsigned char*)test_upgrade_response, sizeof(test_upgrade_response) - 1);
    (void)uws_client_close_handshake(uws_client, 1002, "", NULL, NULL);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(uws_client_close_with_1_pending_send_frames_indicates_the_frames_as_cancelled)
{
    ...
    g_on_io_open_complete(g_on_io_open_complete_context, IO_OPEN_OK);
    g_on_bytes_received(g_on_bytes_received_context, (const unsigned char*)test_upgrade_response, sizeof(test_upgrade_response) - 1);
    (void)uws_client_send_frame(uws_client, WS_FRAME_TYPE_BINARY, NULL, 0, true, test_on_ws_send_frame_complete, (void*)0x4248);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(uws_client_close_with_2_pending_send_frames_indicates_the_frames_as_cancelled)
{
    ...
    g_on_io_open_complete(g_on_io_open_complete_context, IO_OPEN_OK);
    g_on_bytes_received(g_on_bytes_received_context, (const unsigned char*)test_upgrade_response, sizeof(test_upgrade_response) - 1);
    (void)uws_client_send_frame(uws_client, WS_FRAME_TYPE_BINARY, test_frame_1, sizeof(test_frame_2), true, test_on_ws_send_frame_complete, (void*)0x4248);
    (void)uws_client_send_frame(uws_client, WS_FRAME_TYPE_TEXT, test_frame_2, sizeof(test_frame_2), true, test_on_ws_send_frame_complete, (void*)0x4249);
    umock_c_reset_all_calls();
...
/* Tests_SRS_UWS_CLIENT_01_402: [ When `on_underlying_io_open_complete` is called with `IO_OPEN_CANCELLED` while uws is OPENING (`uws_client_open` was called), uws shall report that the open failed by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_UNDERLYING_IO_OPEN_CANCELLED`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_371: [ When `on_underlying_io_open_complete` is called with `IO_OPEN_OK` while uws is OPENING (`uws_client_open` was called), uws shall prepare the WebSockets upgrade request. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_406: [ If not enough memory can be allocated to construct the WebSocket upgrade request, uws shall report that the open failed by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_NOT_ENOUGH_MEMORY`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_373: [ If `xio_send` fails then uws shall report that the open failed by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_CANNOT_SEND_UPGRADE_REQUEST`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_381: [ If the status is 101, uws shall be considered OPEN and this shall be indicated by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `IO_OPEN_OK`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_382: [ If a negative status is decoded from the WebSocket upgrade request, an error shall be indicated by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_BAD_RESPONSE_STATUS`. ]*/
/* Tests_SRS_UWS_CLIENT_01_478: [ A Status-Line with a 101 response code as per RFC 2616 [RFC2616]. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_383: [ If the WebSocket upgrade request cannot be decoded an error shall be indicated by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_BAD_UPGRADE_RESPONSE`. ]*/
/* Tests_SRS_UWS_CLIENT_01_478: [ A Status-Line with a 101 response code as per RFC 2616 [RFC2616]. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_379: [ If allocating memory for accumulating the bytes fails, uws shall report that the open failed by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_NOT_ENOUGH_MEMORY`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_416: [ If called with NULL `buffer` or zero `size` and the state of the iws is OPENING, uws shall report that the open failed by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_INVALID_BYTES_RECEIVED_ARGUMENTS`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_460: [ When a CLOSE frame is received the callback `on_ws_peer_closed` passed to `uws_client_open` shall be called, while passing to it the argument `on_ws_peer_closed_context`. ]*/
...
TEST_FUNCTION(when_a_CLOSE_frame_is_received_while_in_open_the_code_is_reported_to_the_user)
{
    ...
    EXPECTED_CALL(gballoc_realloc(IGNORED_PTR_ARG, IGNORED_NUM_ARG));
    STRICT_EXPECTED_CALL(uws_frame_encoder_encode(buffer_handle, WS_CLOSE_FRAME, NULL, 0, true, true, 0));
    STRICT_EXPECTED_CALL(BUFFER_u_char(buffer_handle)).SetReturn(sent_close_frame);
    STRICT_EXPECTED_CALL(BUFFER_length(buffer_handle)).SetReturn(sizeof(sent_close_frame));
...
TEST_FUNCTION(sending_after_a_close_is_received_does_not_send_anything)
{
    ...
    // act
    result = uws_client_send_frame(uws_client, WS_FRAME_TYPE_BINARY, test_payload, sizeof(test_payload), true, test_on_ws_send_frame_complete, (void*)0x4248);
...
TEST_FUNCTION(uws_client_send_frame_with_NULL_handle_fails)
{
    ...
    // act
    result = uws_client_send_frame(NULL, WS_FRAME_TYPE_BINARY, test_payload, sizeof(test_payload), true, test_on_ws_send_frame_complete, (void*)0x4248);
...
TEST_FUNCTION(uws_client_send_frame_with_NULL_buffer_and_non_zero_size_fails)
{
    ...
    // act
    result = uws_client_send_frame(uws_client, WS_FRAME_TYPE_BINARY, NULL, 1, true, test_on_ws_send_frame_complete, (void*)0x4248);
...
/* Tests_SRS_UWS_CLIENT_01_038: [ `uws_client_send_frame` shall create and queue a structure that contains: ]*/
...
/* Tests_SRS_UWS_CLIENT_01_042: [ On success, `uws_client_send_frame` shall return 0. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_427: [ The encoded frame buffer that shall be used is the buffer created in `uws_client_create`. ]*/
...
TEST_FUNCTION(uws_send_text_frame_succeeds)
{
    ...
    EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
    STRICT_EXPECTED_CALL(uws_frame_encoder_encode(IGNORED_PTR_ARG, WS_TEXT_FRAME, test_payload, sizeof(test_payload), true, true, 0))
        .ValidateArgumentValue_encode_buffer(&buffer_handle);
    STRICT_EXPECTED_CALL(BUFFER_u_char(IGNORED_PTR_ARG))
        .ValidateArgumentValue_handle(&buffer_handle)
        .SetReturn(encoded_frame);
    ...
    // act
    result = uws_client_send_frame(uws_client, WS_FRAME_TYPE_TEXT, test_payload, sizeof(test_payload), true, test_on_ws_send_frame_complete, (void*)0x4248);
...
TEST_FUNCTION(uws_client_send_frame_with_NULL_complete_callback_succeeds)
{
    ...
    // act
    result = uws_client_send_frame(uws_client, WS_FRAME_TYPE_BINARY, test_payload, sizeof(test_payload), true, NULL, NULL);
...
TEST_FUNCTION(on_underlying_io_send_complete_with_OK_indicates_the_frame_as_sent_OK)
{
    ...
    g_on_io_open_complete(g_on_io_open_complete_context, IO_OPEN_OK);
    g_on_bytes_received(g_on_bytes_received_context, (const unsigned char*)test_upgrade_response, sizeof(test_upgrade_response));
    (void)uws_client_send_frame(uws_client, WS_FRAME_TYPE_BINARY, test_payload, sizeof(test_payload), true, test_on_ws_send_frame_complete, (void*)0x4245);
    umock_c_reset_all_calls();
...
/* Tests_SRS_UWS_CLIENT_01_375: [ When `on_underlying_io_error` is called while uws is OPENING, uws shall report that the open failed by calling the `on_ws_open_complete` callback passed to `uws_client_open` with `WS_OPEN_ERROR_UNDERLYING_IO_ERROR`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_376: [ When `on_underlying_io_error` is called while the uws instance is OPEN, an error shall be reported to the user by calling the `on_ws_error` callback that was passed to `uws_client_open` with the argument `WS_ERROR_UNDERLYING_IO_ERROR`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_441: [ All options shall be passed as they are to the underlying IO by calling `xio_setoption`. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_445: [ `uws_client_retrieve_options` shall call `xio_retrieveoptions` to produce an `OPTIONHANDLER_HANDLE` and on success return the new `OPTIONHANDLER_HANDLE` handle. ]*/
TEST_FUNCTION(uws_retrieve_options_calls_the_underlying_xio_retrieve_options_and_returns_the_value)
{
    // arrange
    TLSIO_CONFIG tlsio_config;
    UWS_CLIENT_HANDLE uws_client;
...
/* Tests_SRS_UWS_CLIENT_01_446: [ If `xio_retrieveoptions` fails then `uws_client_retrieve_options` shall fail and return NULL. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_475: [ When `on_underlying_io_close_complete` is called while closing the underlying IO a subsequent `uws_client_open` shall succeed. ]*/
...
/* Tests_SRS_UWS_CLIENT_01_387: [ When `on_underlying_io_close_complete` is called when the uws instance is closing, the `on_ws_close_complete` callback passed to `uws_client_close` shall be called. ]*/
TEST_FUNCTION(when_close_complete_is_called_the_user_callback_is_triggered)
{
    ...
    g_on_io_open_complete(g_on_io_open_complete_context, IO_OPEN_OK);
    g_on_bytes_received(g_on_bytes_received_context, (const unsigned char*)test_upgrade_response, sizeof(test_upgrade_response) - 1);
    (void)uws_client_close_handshake(uws_client, 1002, "", test_on_ws_close_complete, (void*)0x4444);
    g_on_bytes_received(g_on_bytes_received_context, close_frame, sizeof(close_frame));
    umock_c_reset_all_calls();

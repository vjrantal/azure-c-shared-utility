...
/* Tests_SRS_UTF8_CHECKER_01_002: [ If `utf8_checker_is_valid_utf8` is called with NULL `str` it shall return false. ]*/
...
/* Tests_SRS_UTF8_CHECKER_01_003: [ If `length` is 0, `utf8_checker_is_valid_utf8` shall consider `str` to be valid UTF-8 and return true. ]*/
...
/* Tests_SRS_UTF8_CHECKER_01_001: [ `utf8_checker_is_valid_utf8` shall verify that the sequence of chars pointed to by `str` represent UTF-8 encoded codepoints. ]*/

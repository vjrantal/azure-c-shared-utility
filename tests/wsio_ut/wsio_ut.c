...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(uws_client_retrieve_options, TEST_OPTIONHANDLER_HANDLE);
...
/* Tests_SRS_WSIO_01_156: [ All options shall be passed as they are to uws by calling `uws_client_set_option`. ]*/
...
/* Tests_SRS_WSIO_01_119: [ `wsio_retrieveoptions` shall call `uws_retrieveoptions` to produce an `OPTIONHANDLER_HANDLE` and on success return the new `OPTIONHANDLER_HANDLE` handle. ]*/
TEST_FUNCTION(wsio_retrieveoptions_returns_the_value_obtained_from_the_underlying_retrieve_options)
{
    // arrange
    OPTIONHANDLER_HANDLE result;
    CONCRETE_IO_HANDLE wsio;
...
/* Tests_SRS_WSIO_01_120: [ If `uws_retrieveoptions` fails then `wsio_retrieveoptions` shall fail and return NULL.  ]*/
TEST_FUNCTION(when_uws_retrieve_options_fails_then_wsio_retrieveoptions_fails)
{
    // arrange
    OPTIONHANDLER_HANDLE result;
    CONCRETE_IO_HANDLE wsio;

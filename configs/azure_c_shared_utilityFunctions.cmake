...
function(set_platform_files c_shared_dir)
    set(AGENTTIME_C_FILE ${c_shared_dir}/adapters/agenttime_esp8266.c PARENT_SCOPE)
    if(WIN32)
        if(${use_condition})
        ...
        set(PLATFORM_C_FILE ${c_shared_dir}/adapters/platform_esp8266.c PARENT_SCOPE)
        if (${use_socketio})
            set(SOCKETIO_C_FILE ${c_shared_dir}/adapters/socketio_berkeley.c PARENT_SCOPE)
        endif()
        set(THREAD_C_FILE ${c_shared_dir}/adapters/threadapi_esp8266.c PARENT_SCOPE)
        set(TICKCOUTER_C_FILE ${c_shared_dir}/adapters/tickcounter_esp8266.c PARENT_SCOPE)
        if (${use_default_uuid})
            set(UNIQUEID_C_FILE ${c_shared_dir}/adapters/uniqueid_stub.c PARENT_SCOPE)
    else()
